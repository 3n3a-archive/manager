defmodule ManagerWeb.ProjectControllerTest do
  use ManagerWeb.ConnCase

  import Manager.HomepageFixtures

  @create_attrs %{body: "some body", color: "some color", customBg: "some customBg", href: "some href", status: :draft, title: "some title"}
